...
__DEFINE__(1682062488080, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1682062488081,"./event-store":1682062488082}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1682062488081, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1682062488082, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1682062488081,"./utils":1682062488083}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1682062488083, function(require, module, exports) {
...
return __REQUIRE__(1682062488080);
})()
